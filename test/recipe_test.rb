...
# ```
#
# Use TDD to build a `Recipe` and a `CookBook` class that respond to the
 # following interaction pattern.
#
# For the `add_ingredient` method, the first argument is an Ingredient,
# and the second argument is the amount of the ingredient required for the Recipe.
#
